 <!-- <div class="featured">
                        <ul>
                            ...
                            <li class="last"><a href="index.html"><img src="<?php echo URL ?>public/images/pet-dress.jpg" width="300" height="90" alt="Pet Shop" title="Pet Shop" ></a></li>
                        </ul>
            ...
            <div id="footer">
                    <div class="section">
                        <ul>
                            <li>
                                <img src="<?php echo URL ?>public/images/friendly-shirt.jpg" width="240" height="186" alt="Pet Shop" title="Pet Shop">
                            ...
                            <li>
                                <img src="<?php echo URL ?>public/images/skirt-lover2.jpg" width="240" height="186" alt="Pet Shop" title="Pet Shop">
                            ...
                            <li>
                                <img src="<?php echo URL ?>public/images/healthy-dress.jpg" width="240" height="186" alt="Pet Shop" title="Pet Shop">
                            ...
                            <li>
                                ...
                                <h2><a href="index.html">Love...love...love...dress</a></h2>
                                <p>
                                     Lorem ipsum dolor sit amet, consectetuer adepiscing elit,  sed diameusim. <a class="more" href="index.html">Read More</a> 
                                </p>
                                <img src="<?php echo URL ?>public/images/shirt-lover.jpg" width="240" height="186" alt="Pet Shop" title="Pet Shop">
                            </li>   
                        </ul>
                    </div>
                    <div id="footnote">
                        <div class="section">
                           &copy; 2011 <a href="index.html">clothesshop</a>. All Rights Reserved.
                        </div>
                    </div>
            </div>
