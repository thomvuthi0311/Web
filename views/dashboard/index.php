    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= URL ?>index.php/home/"> Admin</a>
            </div>
            <!-- Top Menu Items -->
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>Đã có đơn hàng mới, hãy kiểm tra ngay !</p>
                                    </div>
                                </div>
                            </a>
                        </li>
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="small text-muted"><i class="fa fa-clock-o"></i> Yesterday at 4:30 PM</p>
                                        <p>Đã có đơn hàng mới, hãy kiểm tra ngay !</p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="small text-muted"><i class="fa fa-clock-o"></i> Yesterday at 4:25 PM</p>
                                        <p>Đã có đơn hàng mới, hãy kiểm tra ngay !</p>
                                    </div>
                                </div>
                            </a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <!-- <li>
                        <a href="<?= URL ?>index.php/admin/...List/1"><i class="fa-solid fa-square-star"></i> Quản lí đánh giá</a>
                    </li> -->
                </ul>
            </div>
            <!-- /.navbar-collapse -->
